          ...
          <div data-aos="fade-down">
            ...
            <div className="lg:w-[100%] ">
              <p className="text-[15px] text-brandBlack font-inter font-normal">
                <span className="font-semibold">StudentWallet.org</span> is the{" "}
              ...
              <p className=" lg:w-[55%] mt-[15px] text-[15px]">
                Scholars are encouraged to apply for scholarships with the goal of
            ...
            <a target="_blank" href=" https://www.studentwallet.org/"><button className="p-[13px] px-20 font-[400] flex gap-[15px]  justify-evenly items-center w-[202px]  text-white text-[15px] bg-[#88B830] rounded-xl">
                StudentWallet.org
              ...
              <div className=" flex lg:justify-evenly gap-[10px] w-[66%]  2xl:w-[35%] xl:w-[40%]  md:w-[45%] sm:w-[50%]  h-[42px] ">
                <a className="flex w-[100%]  items-center p-[11px] bg-[#000000] rounded-xl " target="_blank" href="https://apps.apple.com/us/app/studentwallet-org/id1619977680"> 
                ...
                <a className="flex p-[11px] w-[100%] items-center bg-[#000000] rounded-xl " target="_blank" href="https://play.google.com/store/apps/details?id=com.studentwallet&hl=en_US&gl=US">
                <button className="flex">
                  <img
