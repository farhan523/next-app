const Index = () => {
  return (
    <div className="flex flex-wrap">
      <div className="lg:w-1/2 bg-brandBlue flex justify-center py-16 px-4 lg:px-8 xl:pl-40 xl:pr-12">
        <div data-aos="fade-down">
          ...
          <p className="text-brandOrange text-lg mt-8 font-semibold">
            The Fleischer Scholars Enrichment Program takes place during the summer and assists high school students, those entering their senior year, in making the transition to college. Below is just a sample of some of the activities scholars will experience:
          </p>
          <ul>
      ...
      <div
        data-aos="fade-up"
        className="w-full lg:w-1/2 bg-no-repeat bg-center bg-cover mobilebackgrounds"
        style={{ backgroundImage: `url(https://fs-strapi-assets.s3.amazonaws.com/89557_compressed_1_69100e77be.jpg?updated_at=2022-09-16T15:10:36.721Z)` }}
      ></div>
    </div>
  );
};
