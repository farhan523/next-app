  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://fleischerscholars.com/privacy-policy" />
        <meta property="og:type" content="article" />
        <title>Privacy Policy - Fleischer Scholars Program</title>
      </Head>
      <Layout>
        <div className="container mx-auto py-48 xl:px-32 legal-content">
          ...
          <ul>
            ...
            <li>
              <strong>Company </strong>(referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to FLEISCHER FOUNDATION, 300 E. Lemon St. Tempe, AZ 85287
            </li>
            <li>
          ...
          <ul>
            <li>
              <strong>Website </strong>refers to FleischerScholars accessible from https://fleischerscholars.com/
            </li>
            <li>
              <strong>You </strong>means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. <strong>Collecting and Using Your Personal Data</strong> <strong>Types of Data Collected </strong>
              ...
              <ul>
                ...
                <li>
                  Usage Data <strong>Usage Data</strong> Usage Data is collected automatically when using the Service. Usage Data may include information such as Your Device’s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic data. When You access the Service by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other diagnostic data. We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device. <strong>Tracking Technologies and Cookies</strong> We use Cookies and
                  similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:
                </li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              Administered by: Us
              <br />
              Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website. For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy. <strong>Use of Your Personal Data</strong> The Company may use Personal Data for the following purposes:
            </li>
          </ul>
          <ul>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience. We may share Your personal information in the following situations:
            </li>
          </ul>
          <ul>
            <li>
          ...
          <ul>
            ...
            <li>
              Protect against legal liability <strong>Security of Your Personal Data</strong> The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security. <strong>Detailed Information on the Processing of Your Personal Data</strong> The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies. <strong>Usage, Performance and Miscellaneous</strong> We may use third-party Service Providers to provide better improvement of our Service.
            </li>
          </ul>
          <p>
          ...
          <p>If you have any questions about this Privacy Policy, You can contact us: • By email: fleischerscholarsemail@gmail.com</p>
        </div>
      </Layout>
    </>
  );
