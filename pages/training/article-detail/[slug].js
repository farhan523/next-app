...
import ArticlePageDetail from "../../../components/pageComponents/NewMockup/ArticleDetailPage";
...
const ArticleDetail = ({ articleDetail }) => {
  ...
  return (
    <>
      ...
      <ArticlePageDetail article={article} type={"article"} />
    </>
  );
};
...
export const getStaticProps = async (ctx) => {
  try {
    ...
    const article = await fetchAPI(`/training-articles`, {
      filters: { slug: slug },
      populate: "*",
    });
